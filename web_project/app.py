...
def index():
    ...
    if num_row > 0 and msg == '' and (stu_name != "" or stu_id != ""):
        ...
        msg = "查询失败!"
    return render_template('index.html', datas=result, fields=fields, page=page, per_page=per_page, total_pages=total_pages, msg=msg, stu_id=stu_id, stu_name=stu_name)
...
def update():
    ...
    if request.method == 'GET':
        ...
        update_data(data, 'student_info')
        return redirect(url_for('index',msg='修改成功'))
